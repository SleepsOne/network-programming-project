...
public class RoomNameFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        frameTitle.setFont(new java.awt.Font("Segoe UI Black", 0, 24)); // NOI18N
        ...
        findingRoomLabel.setText("Looking for a room");

        passwordLabel.setText("enter password");

        passwordNotificationLabl.setFont(new java.awt.Font("Segoe UI", 2, 10)); // NOI18N
        passwordNotificationLabl.setText("If the room does not have a password, leave it blank");

        findingRoomLabel1.setForeground(new java.awt.Color(0, 51, 255));
        findingRoomLabel1.setText("Looking for a room");
