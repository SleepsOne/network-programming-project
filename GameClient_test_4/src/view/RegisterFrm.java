...
//        avatarComboBox.setMaximumRowCount(6);
//        for (int i = 0; i <= 6; i++) {
...
//        }
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        try {
            ...
            int avatar = 0; // sua o day
            if (avatar == -1) {
//                throw new Exception("Vui lòng chọn avatar");
            }
            if (nickName.isEmpty())
                throw new Exception("Please enter nickname");
            Client.closeAllViews();
            Client.openView(Client.View.GAME_NOTICE, "Signing up", "Loading...");
